...
def create_template(payload: TemplateCreateRequest) -> TemplateResponse:
...
def list_templates(category: str | None = None, public_only: bool = True) -> TemplateListResponse:
...
def get_template(template_id: UUID) -> TemplateResponse:
...
def update_template(template_id: UUID, payload: TemplateUpdateRequest) -> TemplateResponse:
